    ...
    def auth_url(self, request, *args, **kwargs):
        ...
        try:
            ...
            raise exc.BadRequest(_(
                "Invalid Jira server configuration, take a look at: "
                "<a target=\"_blank\" href=\"https://tree.taiga.io/support/importers/jira-importer/\">"
                "Import from Jira documentation"
                "</a>"
            ))
